    ...
    return (
        <div class="bodycard-container">
            <div class="square">
                ...
                <div class="h1">Property owners get free posting when they register</div>
            ...
            <div class="square">
                ...
                <div class="h1">Get some tenants for your property</div>
                <p>Rent your residential / commercial property</p>

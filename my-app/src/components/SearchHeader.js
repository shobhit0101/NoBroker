...
const SearchHeader = () => {
  return (
    ...
    <div className="description">
      <p>Sell or Rent your property for</p>
      <p className="description-text"><strong>free on Perfect View</strong></p>
    </div>
    <div className="search_container">
      <div className="searchbar">
        ...
        <form className="d-flex submit" action="/search" method="post">
          ...
          <input className="form-control me-2 search-text" type="search" placeholder="Search" aria-label="Search" name="search"/>
